...
public class EntityTpUtils {
    ...
    static {
        Field f = null;
        try{
            f = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("vehicle");
...
//        }
    ...
    public static void forgeStopRide(Entity entity) {
        net.minecraft.server.v1_16_R3.Entity ne = ((CraftEntity) entity).getHandle();
        net.minecraft.server.v1_16_R3.Entity nv = ne.getVehicle();
        if (nv != null){
